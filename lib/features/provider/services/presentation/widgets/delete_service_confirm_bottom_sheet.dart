...
/// Confirmation bottom sheet when deleting a service.
class DeleteServiceConfirmBottomSheet extends StatelessWidget {
  final VoidCallback onConfirm;

  const DeleteServiceConfirmBottomSheet({
    super.key,
  ...
  static Future<void> show(
    ...
    return showModalBottomSheet(
      ...
      builder: (_) => DeleteServiceConfirmBottomSheet(
        onConfirm: onConfirm,
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return AppConfirmBottomSheet(
      ...
      title: AppText.deleteServiceExclaim,
      description: Text(
        AppText.areYouSureYouWantToDeleteThisService,
      ...
      confirmColor: const Color(0xFFD93F3F),
      onConfirm: onConfirm,
    );
  }
}
