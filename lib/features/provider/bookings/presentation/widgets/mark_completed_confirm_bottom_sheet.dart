...
/// Confirmation bottom sheet shown when provider confirms marking service as completed (Image 4)
class MarkCompletedConfirmBottomSheet extends StatelessWidget {
  final VoidCallback onConfirm;

  const MarkCompletedConfirmBottomSheet({super.key, required this.onConfirm});
