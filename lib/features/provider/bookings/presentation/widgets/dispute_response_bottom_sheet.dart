...
/// Modal bottom sheet for provider to respond to a customer dispute (matching design in screenshot).
class DisputeResponseBottomSheet extends StatefulWidget {
  final Function(String response, List<String> evidenceImages) onSubmit;

  const DisputeResponseBottomSheet({
    super.key,
    required this.onSubmit,
  });

  @override
  State<DisputeResponseBottomSheet> createState() =>
      _DisputeResponseBottomSheetState();
}

class _DisputeResponseBottomSheetState
    extends State<DisputeResponseBottomSheet> {
  ...
  void _onSubmitResponse() {
    ...
    widget.onSubmit(_responseController.text, _evidenceImages);
  }
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                // Your Response Text Area Container
                Container(
                  decoration: BoxDecoration(
                    ...
                    children: [
                      TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: AppText.explainWhatHappened,
                          hintStyle: TextStyle(
                            fontSize: ResponsiveHelper.fontSize(12),
