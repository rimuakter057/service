...
/// Confirmation sheet shown before unblocking a provider — reached from
/// the Chat screen's "..." menu ("Unblock") and the blocked-state
/// "Unblock Provider" button.
class UnblockProviderBottomSheet extends StatelessWidget {
  final VoidCallback onConfirm;

  const UnblockProviderBottomSheet({super.key, required this.onConfirm});
  ...
  Widget build(BuildContext context) {
    return AppConfirmBottomSheet(
      ...
      title: AppText.unblockThisProviderExclaim,
      description: Text(
        AppText.doYouWantToUnblockThisProviderAndAllowMessagesAgain,
