...
/// Confirmation bottom sheet shown before rescheduling a scheduled booking —
/// reached from Booking Details screen's "Reschedule" button.
class RescheduleBookingBottomSheet extends StatelessWidget {
  final VoidCallback onConfirm;

  const RescheduleBookingBottomSheet({super.key, required this.onConfirm});
  ...
  Widget build(BuildContext context) {
    return AppConfirmBottomSheet(
      ...
      description: Text(
        AppText.youReAboutToRequestANewDateAndTimeForThisBooking,
