...
/// Screen displayed after completing payment on DPO Checkout or booking a service.
/// Displays confirmation badge, provider info, session summary, and "See my bookings" action.
class BookingConfirmedScreen extends StatelessWidget {
  static const String routeName = '/booking-confirmed';
                ...
                child: Column(
                  children: [
                      ...
                      child: Row(
                        children: [
                          ClipRRect(
                            ...
                            child: Image.asset(
                              AssetsPath.exploreProviderDetailsPhoto,
                    ...
                    AppButton(
                      ...
                      onPressed: () {
                        // Navigate to scheduled booking details matching Image 2
