...
import '../../../../../../core/common_widgets/app_icon/app_icon.dart';
import '../../../../../../core/common_widgets/app_top_bar/app_top_bar.dart';
...
import '../../widgets/bookings_sample_data.dart';
import '../booking_confirmed/booking_confirmed_screen.dart';
import '../bookings_screen.dart';

/// DPO Checkout screen supporting Step 1 (Personal Details), Step 2 (Card & Mobile payment),
/// and Step 3 (Payment Successful static screen matching Figma).
class DpoCheckoutScreen extends StatefulWidget {
  static const String routeName = '/bookings/dpo-checkout';

  final BookingHistoryData booking;

  const DpoCheckoutScreen({super.key, required this.booking});

  @override
  State<DpoCheckoutScreen> createState() => _DpoCheckoutScreenState();
}

class _DpoCheckoutScreenState extends State<DpoCheckoutScreen> {
  ...
  void _onProceedPayment() {
    // Switch to Step 3 (Static Payment Successful screen matching Figma)
    setState(() => _currentStep = 3);
  }

  void _handleBack() {
    if (_currentStep == 3) {
      context.go(BookingsScreen.routeName);
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          // DPO Brand Header Row (shown on all steps)
                          _buildDpoHeader(),

                          // Step 1 & 2 show Timer, Stepper, and Service card
                          if (_currentStep != 3) ...[
                            ...
                            // Step 3: Static Payment Successful screen from Figma
                    ...
                    if (_currentStep == 3) ...[
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            context.push(
                              BookingConfirmedScreen.routeName,
  ...
  // ==========================================================
  // STEP 2: PAYMENT METHOD (CARD & MOBILE)
  // ==========================================================
  ...
  // ==========================================================
  // STEP 3: STATIC PAYMENT SUCCESSFUL SCREEN (MATCHING FIGMA)
  // ==========================================================
